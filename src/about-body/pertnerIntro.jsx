import AFirst from '../assets/img/about-01.jpg';
import ASecond from '../assets/img/about-02.jpg';
import AThird from '../assets/img/about-03.jpg';
import AFourth from '../assets/img/about-04.jpg';
import ASixth from '../assets/img/about-06.jpg';
const PartnerIntro = () => {
  return (
    <div>
        ...
        <div className="row">
          <article className="col-lg-6">
            <figure className="tm-person">
              <img src={AFirst} alt="" className="img-fluid tm-person-img" />
          ...
          <article className="col-lg-6">
            <figure className="tm-person">
              <img src={ASecond} alt="" className="img-fluid tm-person-img" />
              <figcaption className="tm-person-description">
          ...
          <article className="col-lg-6">
            <figure className="tm-person">
              <img src={AThird} alt="" className="img-fluid tm-person-img" />
              <figcaption className="tm-person-description">
                <h4 className="tm-person-name">Florence Nelson</h4>
                <p className="tm-person-title">Kitchen Manager</p>
                <p className="tm-person-about">
                  Aenean sapien sem, ultricies sed vulputate et, auctor vel mauris. Integer sit amet diam eget est
          ...
          <article className="col-lg-6">
            <figure className="tm-person">
              <img src={AFourth} alt="" className="img-fluid tm-person-img" />
              <figcaption className="tm-person-description">
        ...
        <div className="row">
          <div className="col-12">
            <div className="placeholder-2">
              <div className="parallax-window-2" data-parallax="scroll" data-image-src="img/about-05.jpg"></div>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="col-lg-4">
            <div className="tm-feature">
              ...
              <p className="tm-feature-description">
                ...
                interdum est. Donec in risus eu ante.
              </p>
          ...
          <div className="col-lg-4">
            <div className="tm-feature">
              ...
              <p className="tm-feature-description">
                ...
                dolor finibus, consequat nisl eget.
              </p>
        ...
        <div className="row">
          <div className="col-12">
            <div className="tm-history-inner">
              <img src={ASixth} alt="" className="img-fluid tm-history-img" />
              <div className="tm-history-text">
                <h4 className="tm-history-title">History of our restaurant</h4>
                <p className="tm-mb-p">
                  Sed ligula risus, interdum aliquet imperdiet sit amet, auctor sit amet justo. Maecenas posuere lorem
                  id augue interdum vehicula. Praesent sed leo eget libero ultricies congue.
                </p>
                <p>
